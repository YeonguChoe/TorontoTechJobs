...
export default function Edit() {
    ...
    useEffect(() => {
        axios.get(`${process.env.SERVER_ADDRESS}/jobs/${postID}`).then((res) => {
    ...
    function handleEditBtn() {
        ...
        if (
            ...
            axios
                .patch(`${process.env.SERVER_ADDRESS}/jobs/${postID}`, newJSON, configuration)
                .then((res) => {
                    window.location.href = "/";
                });
        } else {
            setEmptyField("There exist a empty field!!");
        }
    }
    ...
    return (
        <div className="container">
            ...
            <div className="d-flex justify-content-center align-items-center">
                {emptyField && <h5 style={{color: "#ff0000"}}>{emptyField}</h5>}
            </div>
        </div>
    );
}
